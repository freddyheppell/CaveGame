...
public class Config {
    ...
    public static final int REGION_CACHE_SIZE = 5;
    public static final int ITERATION_COUNT = 2;
    public static final int CELL_DEATH_THRESHOLD = 5;
    public static final String SEED = "abc123";
    public static final float RANDOM_BOUNDARY = 0.5f;
    public static final int VIEW_DISTANCE_H = 5;
    public static final int VIEW_DISTANCE_V = 5;
}
